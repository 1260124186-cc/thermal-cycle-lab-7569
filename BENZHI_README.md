# thermal-cycle-lab-7569 Docker 交付说明
...
```bash
./build_benzhi_docker.sh thermal-cycle-lab-7569-benzhi linux/amd64
docker run --rm -it thermal-cycle-lab-7569-benzhi bash
```
