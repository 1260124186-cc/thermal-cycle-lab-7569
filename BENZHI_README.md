# thermal-cycle-lab__010 Docker 交付说明

基于 Go 实现的材料热循环试验管理 Web 服务，面向实验工程师协调试样登记、温控曲线、传感帧采集和试验报告查询。
...
```bash
./build_benzhi_docker.sh thermal-cycle-lab__010-benzhi linux/amd64
docker run --rm -it thermal-cycle-lab__010-benzhi bash
```
